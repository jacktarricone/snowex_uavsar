...
i_angle_deg_raw2 <-raster("/Volumes/JT/projects/uavsar/jemez/inc/i_angle_deg.tif")
...
amp_diff <-amp1-amp2
plot(amp_diff)
writeRaster(amp_diff, "/Volumes/JT/projects/uavsar/jemez/amp_diff2.tif")
...
p1 <-ggplot(unw_points, aes(x, unwrapped_phase)) +
  ...
  labs(title = "Jemez Unwrapped Phase vs. Longitude HH 2/19-2/26",
...
ggsave(p1,
       file = "unw_graph_2-19_2-26_HH.png",
       width = 6, 
       height = 4,
       dpi = 400)
...
#p9 <-ggplot(unw_corrected_points, aes(x, unwrapped_phase)) +
 # geom_hex(bins = 25) +
  ...
  #geom_abline(slope = coef(lm_fit)[[2]], intercept = coef(lm_fit)[[1]], size = 1)+
  #scale_y_continuous(breaks = seq(-5,6,2))+
  #labs(title = "Jemez River Unwrapped Phase vs. Longitude Corrected HH 2/12-2/19",
   #    x = "Longitude Change (deg)",
    #   y = "Unwrapped Phase (radians)")+
  #theme(axis.line = element_line(colour = "black"),
   #     panel.grid.major = element_blank(),
...
#setwd("/Volumes/JT/projects/uavsar/jemez/swe_calc/")
#ggsave(p9,
#       file = "unw_corrected_graph_2-19_2-26_HH.png",
#       width = 6, 
#       height = 4,
#       dpi = 400)
...
writeRaster(delta_swe_rast,"/Volumes/JT/projects/uavsar/jemez/swe_calc/delta_swe_raster_2-19_2-26_HH.tif")
...
writeRaster(delta_swe_snow_mask,"/Volumes/JT/projects/uavsar/jemez/swe_calc/delta_swe_snow_mask_2-19_2-26_HH.tif")
...
#plot(cc_swe_mask)
#writeRaster(cc_swe_mask, "/Volumes/JT/projects/uavsar/jemez/swe_calc/cc_swe_mask_2-19_2-26_HH.tif")
...
#import
delta_swe_rast <-raster("/Volumes/JT/projects/uavsar/jemez/swe_calc/delta_swe_raster_2-19_2-26_HH.tif")
...
writeRaster(delta_swe_snow_mask_abs,"/Volumes/JT/projects/uavsar/jemez/swe_calc/delta_swe_snow_mask_abs_2-19_2-26_HH.tif")
