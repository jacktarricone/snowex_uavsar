...
{
  # import DEM
  jemez_DEM <-raster("/Volumes/JT/projects/uavsar/jemez/rasters/02192020_02262020/DEM/alamos_35915_20008-000_20013-000_0007d_s01_L090HV_01.hgt.grd.tiff")
  ...
  files <-list.files("/Volumes/JT/projects/uavsar/jemez/rasters/02192020_02262020/HV", full.names = TRUE)
  ...
  p1 <-ggplot(unw_points, aes(x, unwrapped_phase)) +
    ...
    labs(title = "Jemez Unwrapped Phase vs. Longitude HV 2/19-2/26",
  ...
  ggsave(p1,
         file = "unw_graph_2-19_2-26_HV.png",
         width = 6, 
         height = 4,
         dpi = 400)
  ...
  #geom_abline(slope = coef(lm_fit)[[2]], intercept = coef(lm_fit)[[1]], size = 1)+
  #scale_y_continuous(breaks = seq(-5,6,2))+
  #labs(title = "Jemez River Unwrapped Phase vs. Longitude Corrected HV 2/12-2/19",
  #    x = "Longitude Change (deg)",
  #   y = "Unwrapped Phase (radians)")+
  #theme(axis.line = element_line(colour = "black"),
  #     panel.grid.major = element_blank(),
  ...
  #setwd("/Volumes/JT/projects/uavsar/jemez/swe_calc/")
  #ggsave(p9,
  #       file = "unw_corrected_graph_2-19_2-26_HV.png",
  #       width = 6, 
  #       height = 4,
  #       dpi = 400)
  ...
  writeRaster(delta_swe_rast,"/Volumes/JT/projects/uavsar/jemez/swe_calc/delta_swe_raster_2-19_2-26_HV.tif")
  ...
  writeRaster(delta_swe_snow_mask,"/Volumes/JT/projects/uavsar/jemez/swe_calc/delta_swe_snow_mask_2-19_2-26_HV.tif")
  ...
  #plot(cc_swe_mask)
  #writeRaster(cc_swe_mask, "/Volumes/JT/projects/uavsar/jemez/swe_calc/cc_swe_mask_2-19_2-26_HV.tif")
  ...
  #import
  delta_swe_rast <-raster("/Volumes/JT/projects/uavsar/jemez/swe_calc/delta_swe_raster_2-19_2-26_HV.tif")
  ...
  writeRaster(delta_swe_snow_mask_abs,"/Volumes/JT/projects/uavsar/jemez/swe_calc/delta_swe_snow_mask_abs_2-19_2-26_HV.tif")
}


delta_swe_snow_mask_abs <-raster("/Volumes/JT/projects/uavsar/jemez/swe_calc/delta_swe_snow_mask_abs_2-19_2-26_HH.tif")

hist(delta_swe_snow_mask_abs,
     breaks = 100,
     main= "Jemez Change in SWE 2/19-2/26 HH",
     xlab= "SWE Change (cm)",
     xlim=c(-3,2),
     col= "darkmagenta"
)
