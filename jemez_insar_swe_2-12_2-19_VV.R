...
# import DEM
jemez_DEM <-raster("/Volumes/JT/projects/uavsar/jemez/raw_data/02122020_02192020/DEM/alamos_35915_20005-003_20008-000_0007d_s01_L090VV_01.hgt.grd.tiff")
...
files <-list.files("/Volumes/JT/projects/uavsar/jemez/rasters/02122020_02192020/VV", full.names = TRUE)
...
ggsave(p9,
      file = "unw_corrected_graph_2-12_2-19_VV.png",
      width = 6, 
      height = 4,
      dpi = 400)
...
writeRaster(delta_swe_rast,"/Volumes/JT/projects/uavsar/jemez/swe_calc/delta_swe_raster_2-12_2-19_VV.tif")

#mask for snow
delta_swe_snow_mask <- mask(delta_swe_rast, snow_mask, maskvalue = NA)
plot(delta_swe_snow_mask)
writeRaster(delta_swe_snow_mask,"/Volumes/JT/projects/uavsar/jemez/swe_calc/delta_swe_snow_mask_2-12_2-19_VV.tif")
...
plot(cc_swe_mask)
writeRaster(cc_swe_mask, "/Volumes/JT/projects/uavsar/jemez/swe_calc/cc_swe_mask_2-12_2-19_VV.tif")
...
#import
delta_swe_rast <-raster("/Volumes/JT/projects/uavsar/jemez/swe_calc/delta_swe_raster_2-12_2-19_VV.tif")
...
writeRaster(delta_swe_snow_mask_abs,"/Volumes/JT/projects/uavsar/jemez/swe_calc/delta_swe_snow_mask_abs_2-12_2-19_VV.tif")
